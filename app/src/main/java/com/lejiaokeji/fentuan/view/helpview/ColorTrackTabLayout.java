            ...
            try {
                ...
                try {
                    ...
                    mTabTextColor = a.getColor(
                            android.support.design.R.styleable.TextAppearance_android_textColor, Color.BLACK);
                } finally {
                    ta.recycle();
                }
