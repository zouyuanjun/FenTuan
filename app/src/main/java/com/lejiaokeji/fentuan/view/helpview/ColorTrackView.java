...
public class ColorTrackView extends View {
    ...
    public ColorTrackView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs,
                me.weyye.library.R.styleable.ColorTrackView);
        mText = ta.getString(me.weyye.library.R.styleable.ColorTrackView_ctvText);
        mTextSize = ta.getDimensionPixelSize(
                me.weyye.library.R.styleable.ColorTrackView_ctvText_size, mTextSize);
        mTextOriginColor = ta.getColor(
                me.weyye.library.R.styleable.ColorTrackView_ctvText_origin_color, mTextOriginColor);
        mTextChangeColor = ta.getColor(
                me.weyye.library.R.styleable.ColorTrackView_ctvText_change_color, mTextChangeColor);
        mProgress = ta.getFloat(me.weyye.library.R.styleable.ColorTrackView_ctvProgress, 0);

        mDirection = ta
                .getInt(me.weyye.library.R.styleable.ColorTrackView_ctvDirection, mDirection);
