...
//设置状态栏颜色
    ...
    public void getbitmap(String url) throws IOException, ExecutionException, InterruptedException {
        ...
        //缩放标题bitmap
        Log.d("图片数据", "商品图片" + goodsbitmap.getWidth() + "biaoti" + titlebmp.getWidth());
        ...
        Bitmap qrbj = ((BitmapDrawable) db).getBitmap();

        Log.d("图片数据", "二维码背景" + qrbj.getWidth() + "合成" + addbitmap.getWidth());
